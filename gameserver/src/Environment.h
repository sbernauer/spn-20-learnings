...
class Environment
{
        public:
                ...
                static constexpr const char* ENV_MYSQL_USER_DEFAULT = "root";

                static constexpr const char* ENV_MYSQL_PASSWORD = "MYSQL_PASSWORD";
                static constexpr const char* ENV_MYSQL_PASSWORD_DEFAULT = "Uu5ZyuXcQHLcMBQeC9Uih4AWjJuswM3SNCmNS8E8";

                static constexpr const char* ENV_MYSQL_DB = "MYSQL_DB";
                static constexpr const char* ENV_MYSQL_DB_DEFAULT = "snake";
